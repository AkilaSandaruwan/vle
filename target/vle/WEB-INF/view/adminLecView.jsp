        ...
        <div class="row" style="background-color:#d2cdff">
            <div class="col-md-2 position-fixed" style="padding-left: 5px" >
                <div style="background-color:white;padding-bottom: 30px;margin: 10px 0 auto 10px;border-radius: 5px;">
                    ...
                    <div class="list-group" style="padding: 5px 20px 20px 20px;">
                        ...
                        <a href="#" class="list-group-item-secondary list-group-item-action" style="text-align: center;font-size: 1.3vw;padding: 5px">Lecturers</a>
            ...
            <div class="col-md-10" style="margin-left:17vw">
                <div style="border-color: darkslategray;background-color:white;height: 60px; margin: 10px 15px 10px -1vw;border-radius: 5px;display: flex;justify-content: center;align-items: center;">
                    <h3 >Registered Lecturers (Admin Dashboard)</h3>
                </div>
                ...
                <div style="position: sticky;top:5vw;background-color:darkgrey; margin: 10px 15px 10px -1vw;border-radius: 5px">
                    ...
                    <div  style="margin: 0 20px;padding-top: 10px;padding-bottom: 10px;display: flex;justify-content: center">
                        <input id="myInput" onkeyup="searchFun()" style="display: inline-block;width: 40%;margin:auto auto auto 5px;border-color: darkslategray" class="form-control" type="text" placeholder="Search" aria-label="Search">
                        <a href="${pageContext.request.contextPath}/admin/pdf_lec" class="btn btn-dark" style="display: inline-block;float: right;margin-right: 7px;border-color: #f1f1f1">Download</a>
                        <a href="addLecturer"><button class="btn btn-dark" style="display: inline-block;float: right;border-color: #f1f1f1">Add Lecture</button></a>
                    </div>
                </div>
                ${deleted}
                ${download}
                    ...
                    <table class="table table-striped" style="margin: auto auto">
                        ...
                        <c:forEach var="lec" items="${lec_list}">
                            <tr>
                                ...
                                <td>
                                    <a href="updatelectureform/${lec.username}"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    &nbsp;&nbsp;&nbsp;<a  href="" data-toggle="modal" onclick="setUrl('deleteUser/${lec.username}')" data-target="#exampleModalCenter"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
