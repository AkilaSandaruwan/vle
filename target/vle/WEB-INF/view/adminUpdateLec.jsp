            ...
            <div class="col-md-2" style="padding-left: 5px" >
                <div style="background-color:white;padding-bottom: 30px;margin: 10px 0 auto 10px;border-radius: 5px;">
                    ...
                    <div class="list-group" style="padding: 20px;">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/adminLecView" class="list-group-item-secondary list-group-item-action" style="text-align: center;font-size: 1.3vw;padding: 5px">Lecturers</a>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" style="padding: 40px 80px 60px 80px">
                            <div class="panel-heading" style="display: flex;justify-content: center;align-items: center;">
                                <h4 class="panel-title">Update Lecture(${lecturerBean.username}) Details</h4>
                            ...
                            <div>
                                <c:if test="${UpdateFailed!=null}">
                                    <h6 style="color: red"><c:out value="${UpdateFailed}"/></h6>
                                </c:if>
                                <form:form action="${pageContext.request.contextPath}/admin/updatelecturer/${lecturerBean.username}" modelAttribute="lecturerBean" onsubmit="return (emailValidation(this.email) && mobileValidation(this.phone) && homeValidation(this.home) && nicValidation(this.nic));">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" path="lName" id="last_name" class="form-control" placeholder="Last Name"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="email" onkeyup="emailValidation(this.value)" required="true" path="email" name="email" id="email" class="form-control " placeholder="akila@gmail.com"/>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label>Phone number:</label>&nbsp;&nbsp;<p id="mobile_e" style="display: inline;font-size: 13px; font-family: Bahnschrift" class="error"></p>
                                                <form:input type="text" onkeyup="mobileValidation(this.value)" path="mobile" maxlength="10" required="true"  id="mobile" class="form-control " placeholder="0771234567"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label>City:</label>
                                                <form:input type="text" required="true" path="city" name="city" id="city" class="form-control" placeholder="Beliatta"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" path="NIC" onkeyup="nicValidation(this.value)" maxlength="10" required="true" name="nic" id="nic" class="form-control " placeholder="976452413V"/>
                                            </div>
                                        </div>
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <form:select path="rank" class="form-control" id="sel1">
                                                    <form:option value="Professor">Professor</form:option>
                                                    <form:option value="Senior Lecturer">Senior Lecturer</form:option>
                                                    <form:option value="Lecturer">Lecturer</form:option>
                                                    <form:option value="Assistant Lecturer">Assistant Lecturer</form:option>
                                                </form:select>
                                            </div>
                                        </div>
                                    </div><hr>
                                    <div style="display: flex;justify-content: center">
                                        <input type="submit" value="Update" class="btn btn-primary " style="display: inline-block;width: 8vw;margin-right: 5px" />
                                        <a href="${pageContext.request.contextPath}/admin/adminLecView" class="btn btn-secondary" style="display: inline-block;width: 8vw;margin-left: 5px" >Cancel</a>
                                    </div>
