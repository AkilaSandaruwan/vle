                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" style="padding: 40px 80px 60px 80px">
                            <div class="panel-heading" style="display: flex;justify-content: center;align-items: center;">
                                <h4 class="panel-title">Update Student(${student.username}) Details</h4>
                            ...
                            <div>
                                ...
                                <form:form action="${pageContext.request.contextPath}/admin/updatestudent/${student.username}" modelAttribute="student" onsubmit="return (emailValidation(this.email) && mobileValidation(this.phone) && homeValidation(this.home) && nicValidation(this.nic));">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            <div class="form-group">
                                                <label>Year:</label>
                                                <form:select path="sYear" class="form-control" id="sYear" disabled="true">
                                    ...
                                    <div style="display: flex;justify-content: center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/adminStuView" class="btn btn-secondary" style="display: inline-block;width: 8vw;margin-left: 5px" >Cancel</a>
                                    </div>
