<%@ page import="com.akila.vle.bean.SubjectBean" %>
        ...
        <div class="row" style="background-color:#d2cdff">
            <div class="col-md-2 position-fixed" style="padding-left: 5px" >
                <div style="background-color:white;padding-bottom: 30px;margin: 10px 0 auto 10px;border-radius: 5px;">
                    <div>
                        <img src="<spring:url value='/resources/images/common/sidebar.png'/>" width="60%" style="display: block;padding-top: 40px;padding-bottom: 10px;margin-left: auto;margin-right: auto;" alt="logo">
                    </div>
                    <div class="list-group" style="padding: 20px;">
                        ...
                        <a href="#" class="list-group-item-secondary list-group-item-action" style="text-align: center;font-size: 1.3vw;padding: 5px">Subjects</a>
            ...
            <div class="col-md-10" style="margin-left:17vw">
                <div style="border-color: darkslategray;background-color:white;height: 60px; margin: 10px 15px 10px -1vw;border-radius: 5px;display: flex;justify-content: center;align-items: center;">
                    <h3 >Subjects (Admin Dashboard)</h3>
                </div>
                ...
                <div style="position: sticky;top:5vw;background-color:darkgrey; margin: 10px 15px 10px -1vw;border-radius: 5px">
                    ...
                    <div  style="margin: 0 20px;padding-top: 10px;padding-bottom: 10px;display: flex;justify-content: center">
                        ...
                        <a href="#" class="btn btn-dark" style="display: inline-block;float: right;margin-right: 7px;border-color: #f1f1f1">Download</a>
                        <a href="addSubject"><button class="btn btn-dark" style="display: inline-block;float: right;border-color: #f1f1f1">Add Subject</button></a>
                    </div>
                    ...
                    <table class="table table-striped" style="margin: auto auto">
                        ...
                        <c:forEach var="sub" items="${sub_list}">
                            ...
                            <tr>
                                ...
                                <td>${sub.name}</td>
                                <td>${sub.lecturer}</td>
                                <c:if test="${!sub.lecturer.equals('-')}">
                                    <td>${sub.fname} ${sub.lname} (${sub.rank})</td>
                                </c:if>
                                <c:if test="${sub.lecturer.equals('-')}">
                                    <td>-</td>
                                </c:if>
                                <td>${sub.year}</td>
                                <td>
                                    <a href="updatesubjectform/${sub.subjectID}" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    &nbsp;&nbsp;&nbsp;<a href="" data-toggle="modal" onclick="setUrl('deleteSubject/${sub.subjectID}')" data-target="#exampleModalCenter" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        </c:forEach>
