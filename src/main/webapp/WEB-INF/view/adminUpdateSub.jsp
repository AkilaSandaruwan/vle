                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" style="padding: 40px 80px 60px 80px">
                            <div class="panel-heading" style="display: flex;justify-content: center;align-items: center;">
                                <h4 class="panel-title">Update Subject(${subjectBean.subjectID}) Details</h4>
                            ...
                            <div>
                                ...
                                <form:form action="${pageContext.request.contextPath}/admin/updatesubject/${subjectID}" modelAttribute="subjectBean" >
                                    <div class="row">
