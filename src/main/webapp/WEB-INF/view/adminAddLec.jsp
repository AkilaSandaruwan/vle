                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default" style="padding: 40px 80px 60px 80px">
                            <div class="panel-heading" style="display: flex;justify-content: center;align-items: center;">
                                <h4 class="panel-title">Lecturer Registration</h4>
                            ...
                            <div>
                                ...
                                <form:form action="saveLecturer" modelAttribute="lecturer" method="post" onsubmit="return (emailValidation(this.email) && mobileValidation(this.phone) && homeValidation(this.home) && nicValidation(this.nic));">
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label>First name:</label>
                                                <form:input path="fName" required="true" class="form-control" placeholder="First Name"  />
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" required="true" path="lName" id="last_name" class="form-control" placeholder="Last Name"/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="email" required="true" onkeyup="emailValidation(this.value)" path="email" name="email" id="email" class="form-control " placeholder="akila@gmail.com"/>
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" required="true" maxlength="10" onkeyup="mobileValidation(this.value)" path="mobile" name="phone" id="phone" class="form-control " placeholder="0771234567"/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" required="true" maxlength="10" onkeyup="homeValidation(this.value)" path="home" name="home" id="home" class="form-control" placeholder="0471234567"/>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3 col-sm-3 col-md-3">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" maxlength="10" onkeyup="nicValidation(this.value)" path="NIC" name="nic" id="nic" class="form-control " placeholder="976452413V"/>
